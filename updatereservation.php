...
<form class="form-horizontal" action="updatereservation.php" method="POST" >
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" name="reservation_id" required="required" id="Motornumber" placeholder="Reservation Number">
        </div>
    </div>
    <div class="control-group">
    ...
    <div class="control-group">
        <div class="controls">
            ...
            <input class="btn btn-large btn-success" type="submit" name="update_reservation" value="Update Reservation" />
