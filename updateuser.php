...
<form class="form-horizontal" action="updateuser.php" method="POST" >
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <select class="span1" name="user_type_id" style="width:300px;">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" name="firstname" required="required" id="inputFname1" placeholder="First Name">
        </div>
    </div>
    <div class="control-group">
        <label class="control-label" for="inputLnam">Last name <sup>*</sup></label>
        <div class="controls">
            <input type="text" name="lastname" required="required" id="inputLnam" placeholder="Last Name">
        </div>
    </div>
    <div class="control-group">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="number" name="ssn" required="required" id="inputSSN1" placeholder="SSN">
        </div>
    </div>
    <div class="control-group">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="password" name="password" required="required" id="inputPassword1" placeholder="Password">
        </div>
    </div>
    <div class="control-group">
        <label class="control-label" for="inputPassword1">Password <sup>*</sup></label>
        <div class="controls">
            <input type="password" name="password_again" required="required" id="inputPassword1" placeholder="Retype-Password">
        </div>
    </div>
    <!--	<div class="control-group">
    ...
    <div class="control-group">
        <div class="controls">
            ...
            <input class="btn btn-large btn-success" type="submit" name="updateuser" value="Update User" />
