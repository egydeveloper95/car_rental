...
$user_info=$user->GetUserDetails($_SESSION['user']['id']);
$user_info['id'];
$user_info['firstname'];
$user_info['lastname'];
$user_info['password'];
                ...
                <div class="well">
                    ...
                    <form class="form-horizontal" action="editprofile.php" method="POST" >
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="firstname" value="<?php echo $user_info['firstname']; ?>" required="required" id="inputFname1" placeholder="First Name">
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="inputLnam">Last name <sup>*</sup></label>
                            <div class="controls">
                                <input type="text" name="lastname" value="<?php echo $user_info['lastname']; ?>" required="required" id="inputLnam" placeholder="Last Name">
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="input_email">Email <sup>*</sup></label>
                            <div class="controls">
                                <input type="email" name="email" value="<?php echo $user_info['email']; ?>" required="required" id="input_email" placeholder="Email">
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="inputSSN1">SSN <sup>*</sup></label>
                            <div class="controls">
                                <input type="number" name="ssn" value="<?php echo $user_info['ssn']; ?>" required="required" id="inputSSN1" placeholder="SSN">
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="password" name="password" value="<?php echo $user_info['password']; ?>" required="required" id="inputPassword1" placeholder="Password">
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="inputPassword1">Password <sup>*</sup></label>
                            <div class="controls">
                                <input type="password" name="password_again" value="<?php echo $user_info['password']; ?>" required="required" id="inputPassword1" placeholder="Retype-Password">
                            </div>
                        </div>
                        <!--	<div class="control-group">
                        ...
                        <div class="control-group">
                            <div class="controls">
                                ...
                                <input class="btn btn-large btn-success" type="submit" name="editprofile" value="Edit" />
                                <a href="myprofile.php" role="button" style="padding-right:0"><span class="btn btn-large btn-danger">Back</span></a>
                            </div>
                        </div>		
                    </form>
                </div>
