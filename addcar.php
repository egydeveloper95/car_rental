...
?>
<form class="form-horizontal" enctype="multipart/form-data" action="addcar.php" method="POST" >
    ...
    <div class="control-group">
        <div class="controls">
            ...
            <input class="btn btn-large btn-success" type="submit" name="addcar" value="Add Car" />
