...
<form class="form-horizontal" action="cancelreservation.php" method="POST" >
    ...
    <div class="control-group">
        <label class="control-label" for="Reservation Number">Reservation-Number <sup>*</sup></label>
        <div class="controls">
            <input type="number" name="reservation_id" required="required" id="Reservation Number" placeholder="Reservation Number">
        </div>
    </div>
    ...
    <div class="control-group">
        <div class="controls">
            ...
            <input class="btn btn-large btn-success" type="submit" name="cancel_reservation" value="Cancel Reservation" />
